...
<form method="POST" action="edit.php?edit_form=<?php echo $showrow ?>" autocomplete="off">
...
mysqli_query($conn,"UPDATE `register` SET `password`='$upass',`username`='$uname',`email`='$uemail' WHERE id = '$uid'");
